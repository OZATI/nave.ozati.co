...
description: Review UI code for Vercel Web Interface Guidelines compliance including accessibility, focus states, forms, animation, typography, performance, touch, and hydration safety. Use when auditing, reviewing, or writing UI components.
